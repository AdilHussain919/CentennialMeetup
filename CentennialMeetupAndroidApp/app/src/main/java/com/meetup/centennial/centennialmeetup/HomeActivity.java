   ...
   public  String Userid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent t =getIntent();
         ...
         Userid = t.getExtras().getString("UserId");
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                searchIntent.putExtra("Uid",Userid);
        ...
        try{
            String url = "http://10.0.2.2:8000/centennialmeetup/getprofile?centennialid=" + Userid;
            ...
            TextView fname = (TextView) header.findViewById(R.id.UsernameTV);
            fname.setText(json.getString("firstname"));
            TextView campus = (TextView) header.findViewById(R.id.UserCampusTV);
